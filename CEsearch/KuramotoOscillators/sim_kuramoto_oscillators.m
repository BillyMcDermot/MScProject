function [phase, sigma_chi, synchrony] = sim_kuramoto_oscillators(intra_comm_size, n_communities, kuramoto_coupling_matrix, beta, npoints)
...
for t = 2:T
   ...
   phase(t,:) = temp1;							% add sukcessively rows (time-points) of the 256 oscillators
